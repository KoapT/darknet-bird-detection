...
class YoloTest(object):
    def __init__(self):
        ...
        model = YOLOV3(self.input_data, trainable=False, tiny=TINY)
    ...
    def predict(self, image):
        ...
        image_data, _ = utils.image_preporcess(image, [self.input_size, self.input_size], keep_aspect_ratio=False)
