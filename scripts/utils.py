...
#when roslaunch, filename need change to the Absolute Path
def get_config(key, filename='/home/robot/catkin_ws/src/vision_find_bird/scripts/config_for_ros.json'):
    try:
...
def non_max_suppression(predictions_with_boxes, confidence_threshold, iou_threshold=0.3)-> dict:
    """
